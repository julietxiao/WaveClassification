'''
————欧氏距离
	f=文件实际频率时 所有样本中6个侧面数据求norm、mark、real值、sin值、欧氏距离、绘图
'''
import os
import pandas as pd 
import numpy as np
...
def main():
	res=r'F:\\Desktop\\1_datasorting_allfiles(9)\\' #处理前原始所有文件所在的文件夹
	list = r'F:\\Desktop\\1_datalist.txt'			#res数据名字汇总txt
	real_val_Path=r'F:\\Desktop\\3_real_val_files\\'#处理后所有real_val所在的文件夹
	sin_val_Path=r'F:\\Desktop\\3_sin_val_files\\' #处理后所有sin_val所在的文件夹
	sub_val_Path=r'F:\\Desktop\\3_sub_val_files\\' #处理后所有sub_val所在的文件夹
